    ...
    <main>
      <div className='ladoEsquerdo'>
        ...
        <div className="itemForm">
          ...
          {foto ?  <img src={URL.createObjectURL(foto)} width='50'></img>: <img src="" width="200"></img>} 

          </div>
          <div className="itemForm">
            <label>Adicione sua logomarca: </label>
            <input type="file" name='flogo' onChange={(e)=> setLogo(e.target.files[0])}></input>
            {logo ? <img src={URL.createObjectURL(logo)} alt="Logomarca" width='200px'></img> : <img src=""  ></img>}
      ...
      <div className="ladoDireito">
          <div className={imgfundo}>
            ...
            <div className="ptMeio ">
              <div>
              {foto ?  <img src={URL.createObjectURL(foto)} width='110px' height='150px'></img>: <img src=""></img>}
              </div>
